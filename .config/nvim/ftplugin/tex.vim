nnoremap <buffer> <F1> :w<Enter>:silent !pdflatex %<Enter>
inoremap <buffer> <F1> <ESC>:w<Enter>:silent !pdflatex %<Enter>
vnoremap <buffer> <F1> <ESC>:w<Enter>:silent !pdflatex %<Enter>
